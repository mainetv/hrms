@php
  $getRequestStatusSignatories = getSignatories(['module_id' => 1])->mapWithKeys(function($row) {
    $user = $row->user;
    if (!$user) return [];
  ...
  <div class="card-header">
    <div class="row">
      <div class="col-11">
        ...
        <button class="btn btn-primary" id="add-button">Add BURS</button>
    </div>
  </div>
  <div class="card-body">
...
@include('financial.modals.request_status')
